...
function loadGame() {
  ...
  if(document.forms[saved_games_form].saved_games.selectedIndex > 0) {
    ...
    if($('#new_grp_type').val() == gameStr.substring(0, gameStr.indexOf(':')).toLowerCase()) window.undoManager.add(gameStr);
    ...
    app.view.UI.setGameState(null);  // TODO
  }
  */
}
